...
save_path = projectdir("plots", "chen_burgers_results.pdf")
savefig(save_path)
...
#
    ...
    #ax_L2 = Axis(fig[1, 1], yscale=log10, xticks=N_el_xys_linear, xlabel=L"N_{x}", ylabel="L2 error")
    #ax_time = Axis(fig[1, 2], yscale=log10, xticks=N_el_xys_linear, xlabel=L"N_{x}", yticks=[1, 5, 10, 20], ylabel="CPU time (s)")
#
